"""
Django settings for git_track project.
...
WSGI_APPLICATION = 'git_track.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('MYSQL_DATABASE', 'git_commits'),
...
SPECTACULAR_SETTINGS = {
    ...
    'TITLE': 'Git Tracking API Documentation',
    'DESCRIPTION': 'Git Tracking API Documentation',
    ...
    'EXTENSIONS_INFO': {
        ...
        'x-application-name': 'Git Tracking API',
